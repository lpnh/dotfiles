...
vim.api.nvim_create_user_command('Dotfiles', search_dotfiles, {})

-- Custom search neovim config files
...
vim.keymap.set('n', '<leader>sc', search_dotfiles, { desc = '[S]earch [C]onfig - Dotfiles' })
